...
public class MapParser {
	...
	String path = "/Users/brunomiguel/IdeaProjects/SD1_rabbit/src/edu/ufp/inf/sd/rabbitmqservices/project/consumer/awgame/maps";
	...
	private String CityID(Base bld) {
		String a = "00";
	...
	private String UnitID(edu.ufp.inf.sd.rabbitmqservices.project.consumer.awgame.units.Base unit) {
		String a = "00";
	...
	private List<Base> FormatCities(List<Base> oldblds) {
		List<Base> newblds = new ArrayList<Base>();
