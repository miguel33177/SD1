...
import edu.ufp.inf.sd.rabbitmqservices.project.consumer.awgame.menus.EndBattle;
...
public class Battle {
	...
	public void NewGame(String mapname) {
		Game.player = new ArrayList<edu.ufp.inf.sd.rabbitmqservices.project.consumer.awgame.players.Base>();
		Game.builds = new ArrayList<Base>();
		Game.units = new ArrayList<edu.ufp.inf.sd.rabbitmqservices.project.consumer.awgame.units.Base>();
		Game.view.Loc.x = 0;
		Game.view.Loc.y = 0;
	...
	public void EndTurn() {
		edu.ufp.inf.sd.rabbitmqservices.project.consumer.awgame.players.Base ply = Game.player.get(currentplayer);
		for (edu.ufp.inf.sd.rabbitmqservices.project.consumer.awgame.units.Base unit : Game.units) {
			unit.acted=false;
			unit.moved=false;
		}
		currentplayer++;
